...
extinct_animals.keep_if {|animal, year|
  year < 2000}
...
# Easier method (built-in):
def extinction_checker(hash, animal)
  hash.has_key?(animal)
end

p extinction_checker(extinct_animals, "Dodo")
p extinction_checker(extinct_animals, "Andean Cat")
p extinction_checker(extinct_animals, "Saiga Antelope")
